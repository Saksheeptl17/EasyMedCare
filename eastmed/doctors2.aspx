<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="doctors2.aspx.cs" Inherits="doctors2" %>
    ...
    <div class="container">
      ...
      <div class="main-form">
        <div class="row mt-5 ">
          ...
          <asp:Button ID="Button1" runat="server" Text="Submit"  class="btn btn-primary mt-3 wow zoomIn" />
      </div>
    </div>
  </div> 
</asp:Content>
