...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="page-hero bg-image overlay-dark" style="background-image:url(bg_image_1.jpg)">
    <div class="hero-section">
      <div class="container text-center wow zoomIn">
        <span class="subhead">Let's make your life happier</span>
        <h1 class="display-4">Healthy Living</h1>
          <asp:Button ID="Button1" runat="server" Text="Book Free Demo" class="btn btn-primary" OnClick="Button1_Click1" />
      </div>
    </div>
  </div>
     ...
     <div class="page-section pb-0">
      <div class="container">
        <div class="row align-items-center">
          ...
          <asp:HyperLink ID="HyperLink1" runat="server" class="btn btn-primary" NavigateUrl="~/about.aspx"> Learn More</asp:HyperLink>
          </div>
          <div class="col-lg-6 wow fadeInRight" data-wow-delay="400ms">
            <div class="img-place custom-img-1">
                <img src="bg-doctor.png" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row mt-5">
        ...
        <div class="col-12 text-center mt-4 wow zoomIn">
            <asp:HyperLink ID="HyperLink2" runat="server"  class="btn btn-primary" NavigateUrl="~/news.aspx">Read More</asp:HyperLink>
    ...
    <div class="container">
      ...
      <div class="main-form">
        <div class="row mt-5 ">
          ...
          <asp:Button ID="Button2" runat="server" Text="Book Free Demo"  BorderStyle="Double" class="btn btn-primary mt-3 wow zoomIn" OnClick="Button2_Click"/>
      </div>
    </div>
  </div> 
